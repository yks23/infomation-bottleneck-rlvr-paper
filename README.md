...
This repository contains the `information-bottleneck-rlvr` writing project.
...
The generated PDF is written to `build/main.pdf`. Generated build files and
downloaded PDFs are ignored by git; source figures under `figures/` are tracked.

## Reading List

The rest of this README collects OpenReview papers related to information theory,
information bottlenecks, entropy, feedback granularity, and RLVR.
